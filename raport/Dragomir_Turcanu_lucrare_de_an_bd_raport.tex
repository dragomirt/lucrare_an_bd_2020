...
\begin{scope}[every node/.style={circle,thick,draw}]
    \node (users) at (0,6) {Users};
    \node[text width=1.5cm, align=center]  (user_ratings) at (3, 6) {User ratings};
	\node (listings) at (5, 2) {Listings};
	\node (locations) at (0, 0) {Locations};
	\node (availability) at (0, 3) {Availability};
	\node (ratings) at (3, -1) {Ratings};
	\node (options) at (5, -1) {Options};
	\node (comments) at (7, -1) {Comments};
	\node (pricing) at (8, 2) {Pricing};
	\node[text width=1.5cm, align=center] (available_options) at (5, -4) {Available options};
...
\begin{scope}[>={Stealth[black]},
    ...
    \path [->] (user_ratings) edge (users);
    	\path [->] (users) edge (user_ratings);
    	...
    	\path [->] (listings) edge (availability);
    	\path [->] (availability) edge (listings);
    	
    	\path [->] (listings) edge (ratings);
    	\path [->] (ratings) edge (listings);
    	
    	\path [->] (listings) edge (options);
    	\path [->] (options) edge (listings);
    	
    	\path [->] (listings) edge (comments);
    	\path [->] (comments) edge (listings);
    	
    	\path [->] (listings) edge (pricing);
    	\path [->] (pricing) edge (listings);
    	
    	\path [->] (options) edge (available_options);
    	\path [->] (available_options) edge (options);
    	
    	\path [->] (listings) edge (exchanges);
